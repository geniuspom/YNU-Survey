      ...
      <div className="header navbar">
        <div className="header-container">
          <ul className="nav-left">
            <li>
              <a onClick={() => Sidebartoggle()} id='sidebar-toggle' className="sidebar-toggle" href={undefined}>
                <i className="ti-menu"></i>
              </a>
            </li>
            <li className="search-box">
              <a className="search-toggle no-pdd-right" href={undefined}>
          ...
          <ul className="nav-right">
            <li className="notifications dropdown">
              ...
              <a href={undefined} className="dropdown-toggle no-after" data-toggle="dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                  <ul className="ovY-a pos-r scrollable lis-n p-0 m-0 fsz-sm">
                    <li>
                      <a href={undefined} className='peers fxw-nw td-n p-20 bdB c-grey-800 cH-blue bgcH-grey-100'>
            ...
            <li className="dropdown">
              ...
              <ul className="dropdown-menu fsz-sm">
                ...
                <li>
                  <a href={undefined} onClick={() => gologout()} className="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
